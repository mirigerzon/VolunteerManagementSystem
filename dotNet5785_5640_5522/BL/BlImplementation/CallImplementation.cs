...
internal class CallImplementation : BlApi.ICall
{
    ...
    {
        List<BO.Call> calls = new List<BO.Call>();
    ...
    public void Create(BO.Call call)
    {
        ...
        try
        {
            double? latitude = Helpers.CallManager.GetLatitudLongitute(call.CallerAddress).Latitude;
            double? longitude = Helpers.CallManager.GetLatitudLongitute(call.CallerAddress).Longitude;
