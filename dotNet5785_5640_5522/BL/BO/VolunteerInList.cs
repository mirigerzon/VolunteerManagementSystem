...
public class VolunteerInList
{
    ...
    {
        return $"Id: {Id}, Name: {FullName}, isActive: {IsActive},TotalHandledCalls: {TotalHandledCalls}, TotalCanceledCalls: {TotalCanceledCalls}, ExpiredCallsCount: {ExpiredCallsCount}";
    }
}
